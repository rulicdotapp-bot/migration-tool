    ...
    <div class="theme-costs-container site-container">
        ...
        <div class="theme-costs-media">
            <div class="theme-costs-media__frame">
                ...
                <?php else : ?>
                    <div style="width:100%; height:100%; display:flex; align-items:center; justify-content:center; background:#f8fafc; color:#cbd5e1; font-size:40px;" aria-hidden="true">📷</div>
                <?php endif; ?>
            </div>
        </div>
