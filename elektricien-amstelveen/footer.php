    ...
    <div class="theme-footer-container">
        ...
        <div class="theme-footer-top">
            <div class="theme-footer-brand">
                ...
                <?php else : ?>
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="theme-footer-logo-text" aria-label="<?php echo esc_attr( get_bloginfo('name') ); ?> - Home">
                        <span itemprop="name">Elektricien</span><span style="color: var(--color-primary);">Amstelveen</span>
                    </a>
                <?php endif; ?>
